...
function draw() {
  // deep background wash (transparent canvas over photo)
  ...
  for (const p of particles) {
    ...
    // pointer push (smoke reacts to cursor/touch)
    ...
    if (dist < pushRadius) {
      ...
      // push away + add pointer velocity for “swirl”
  ...
  // slowly decay pointer activity if mouse stops
  pointer.vx *= 0.92;
  pointer.vy *= 0.92;
